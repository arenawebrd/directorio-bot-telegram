document.addEventListener('DOMContentLoaded', () => {
    ...
    const SUPABASE_URL = 'https://supabase.arenaweb.dpdns.org/';
    const SUPABASE_ANON_KEY = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJyb2xlIjoiYW5vbiIsImlzcyI6InN1cGFiYXNlIiwiaWF0IjoxNzcwMDczMjAwLCJleHAiOjE5Mjc4Mzk2MDB9.XHo6gMU3_ePBio97Cwcp2GNlE8K6LiOjR5vOLlK1jW0';
    ...
    function initializeMap() {
        ...
        map = new mapboxgl.Map({
            ...
            center: [-70.1627, 18.7357], // Centro inicial (República Dominicana)
            zoom: 7
        });
    ...
    function showDetailsModal(listing) {
        ...
        modalBody.innerHTML = `
            ...
            <div class="modal-actions">
                ${listing.check_url ? `
                <a href="${listing.check_url}" target="_blank" rel="noopener noreferrer" class="action-button">
                    <svg viewBox="0 0 24 24"><path fill="currentColor" d="M21.71 11.29l-9-9a.996.996 0 00-1.41 0l-9 9a.996.996 0 000 1.41l9 9c.39.39 1.02.39 1.41 0l9-9a.996.996 0 000-1.41zM14 14.5V12h-4v3H8v-4c0-.55.45-1 1-1h4.5V7.5L17 10l-3 2.5z"/></svg>
                    <span>Dirección</span>
                </a>` : ''}
                ${listing.phone ? `
                <a href="tel:${listing.phone}" class="action-button">
                ...
                ${listing.website ? `
                <a href="${listing.website}" target="_blank" rel="noopener noreferrer" class="action-button">
            ...
            <div class="modal-details">
                <div class="detail-item">
                    ...
                    ${listing.check_url ? `<a href="${listing.check_url}" target="_blank" rel="noopener noreferrer">${listing.address_info_address || listing.address || 'No disponible'}</a>` : `<span>${listing.address_info_address || listing.address || 'No disponible'}</span>`}
                </div>
                ${listing.phone ? `
                <div class="detail-item">
                    <svg viewBox="0 0 24 24"><path fill="currentColor" d="M6.62 10.79c1.44 2.83 3.76 5.14 6.59 6.59l2.2-2.2c.27-.27.67-.36 1.02-.24 1.12.37 2.33.57 3.57.57.55 0 1 .45 1 1V20c0 .55-.45 1-1 1-9.39 0-17-7.61-17-17 0-.55.45-1 1-1h3.5c.55 0 1 .45 1 1 0 1.25.2 2.45.57 3.57.11.35.03.74-.25 1.02l-2.2 2.2z"/></svg>
